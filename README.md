...
## How to inference with single image In Kitti datasets

You need to change the file path in do_inference_image.py.

```
python do_inference_image.py
```

Then, you can run with visualization. 

```
python visualization3DBox_single.py
