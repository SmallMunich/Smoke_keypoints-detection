...
def do_kitti_detection_evaluation(dataset,
    ...
    #######################################################
    # up code is generate test image prediction text file.
    #######################################################
    ...
    # print(os.path.isfile('evaluate_object_3d_offline'))
    # print(os.path)
    if not os.path.isfile('evaluate_object_3d_offline'):
        subprocess.Popen('g++ -O3 -DNDEBUG -o evaluate_object_3d_offline /home/ubuntu/Downloads/SMOKE/smoke/data/datasets/evaluation/kitti/evaluate_object_3d_offline.cpp', shell=True)
