...
class PostProcessor(nn.Module):
    ...
    def forward(self, predictions, targets):
        ...
        '''
            About how to fix shape with view function.
            
            A = pred_regression.shape  [1, 3, 320, 96]
            
            size = len(A)  4 
            
            A[0]: 1  A[1]: 3  A[2]: 320  A[3]: 96
            
            .view(-1, self.reg_head) equals to  .view( A[0]*A[1]*A[2]*A[3]/self.reg_head , self.reg_head)
        ...
        # return clses, scores, pred_proj_points, pred_depths_offset, pred_proj_offsets, pred_dimensions_offsets, pred_orientation
